...
if(isset($_POST["Complete"])){
  $id=$_POST['Order_id'];
  $query = "UPDATE orders SET AStatus ='4' WHERE Order_id = '$id'"; 
          ...
          <style>
            #midlebar{
                ...
                margin-right: 0;
                  ...
                  <h2  id="tablediv">Processing Orders</h2>
                  <style>
                    #tablediv{
                      position: absolute;
                      margin: 20px;
                  ...
                  <div style="position: absolute; left: 50px; top: 100px; width:90%; height: 80%;">
                    ...
                    $query = "SELECT COUNT(Order_id) AS total_rows FROM orders WHERE AStatus = 3";
        ...
        <td>{$result['Customer_Phone_no']}</td>
                      <td>
                          <form method='post'>
                              ...
                              <input type='submit' name='Complete' class='buttons_style' value='Complete' ><br>
                          </form>
                    ...
                    if ($page_number >= $lastpage_no) {
                      ...
                      $next = "<a id='next' href=\"To Ship.php?page={$next_page_no}\">NEXT</a>";
                  }
                  ...
                  if ($page_number <= 1) {
                      ...
                      $previs = "<a id='previous' href=\"To Ship.php?page={$prev_page_no}\">PREVIOUS</a>";
                  }
              ...
              <div id="upbuttons">
                ...
                <a href="To Ship.php" class="upbutton" id="up1" >Processing</a>
