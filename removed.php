          ...
          <style>
            #midlebar{
                ...
                margin-right: 0;
                  ...
                  <h2  id="tablediv">Removed Products </h2>
                  <style>
                    #tablediv{
                      position: absolute;
                      margin: 20px;
                  ...
                  <div style="position: absolute; left: 50px; top: 100px; width:90%; height: 80%;">
                    ...
                    $query = "SELECT COUNT(Product_id) AS total_rows FROM product WHERE Unlisted_or_Deleted = 0";
                    ...
                    $query = "SELECT Product_id, Images, Title, Catagory FROM product WHERE Unlisted_or_Deleted = 0 ORDER BY time_date DESC LIMIT {$start}, {$rows_per_page}";
                    $result_set = mysqli_query($connection, $query);

                    $table = "<table>";
                    $table .= "<tr><th>PRODUCT_ID</th><th>PRODUCT</th><th>TITLE</th><th>CATERGORRY</th></tr>";

                    while($result = mysqli_fetch_assoc($result_set)){
                      $table .= "<tr><td>{$result['Product_id']}</td><td><img src='{$result['Images']}' class = 'productimg'></td><td>{$result['Title']}</td><td>{$result['Catagory']}</td></tr>";
                    ...
                    if ($page_number >= $lastpage_no) {
                      ...
                      $next = "<a id='next' href=\"removed.php?page={$next_page_no}\">NEXT</a>";
                  }
                  ...
                  if ($page_number <= 1) {
                      ...
                      $previs = "<a id='previous' href=\"removed.php?page={$prev_page_no}\">PREVIOUS</a>";
                  }
              ...
              <div id="upbuttons">
                ...
                <a href="removed.php" class="upbutton" id="up1" >Removed</a>
