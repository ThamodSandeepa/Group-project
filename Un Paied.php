...
if(isset($_POST["Processing"])){
  $id=$_POST['Order_id'];
  $query = "UPDATE orders SET AStatus ='3' WHERE Order_id = '$id'"; 
          ...
          <style>
            #midlebar{
                ...
                margin-right: 0;
                  ...
                  <h2  id="tablediv">Confirmed Orders</h2>
                  <style>
                    #tablediv{
                      position: absolute;
                      margin: 20px;
                  ...
                  <div style="position: absolute; left: 50px; top: 100px; width:90%; height: 80%;">
                    ...
                    $query = "SELECT COUNT(Order_id) AS total_rows FROM orders WHERE AStatus = 2";
        ...
        <td>{$result['Customer_Phone_no']}</td>
                      <td>
                          <form method='post'>
                              ...
                              <input type='submit' name='Processing' class='buttons_style' value='Processing' ><br>
                          </form>
                    ...
                    if ($page_number >= $lastpage_no) {
                      ...
                      $next = "<a id='next' href=\"Un Paied.php?page={$next_page_no}\">NEXT</a>";
                  }
                  ...
                  if ($page_number <= 1) {
                      ...
                      $previs = "<a id='previous' href=\"Un Paied.php?page={$prev_page_no}\">PREVIOUS</a>";
                  }
              ...
              <div id="upbuttons">
                ...
                <a href="Un Paied.php" class="upbutton" id="up1" >Confirmed</a>
