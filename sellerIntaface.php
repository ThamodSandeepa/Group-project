...
if(isset($_POST["Confirm"])){
  $id=$_POST['Order_id'];
  $query = "UPDATE orders SET AStatus ='2' WHERE Order_id = '$id'"; 
  $query_run = mysqli_query($connection, $query);
  $price_input = $_POST['price_input'];
  $query2 = "UPDATE orders SET Price ='$price_input' WHERE Order_id = '$id'";
...
<html>
    ...
    <body style="background-color: rgb(215, 215, 215);">
        <div id="upbar">
            ...
            <a href="logout.php" class="customLink" id="logout"><img src="44.png" id="logoutimage">Log out </a>
          ...
          <style>
            #midlebar{
                ...
                margin-right: 0;
                  ...
                  <h2  id="tablediv">To Review Orders</h2>
                  <style>
                    #tablediv{
                      position: absolute;
                      margin: 20px;
                  ...
                  <div style="position: absolute; left: 50px; top: 100px; width:90%; height: 80%;">
                    ...
                    $query = "SELECT COUNT(Order_id) AS total_rows FROM orders WHERE AStatus = 1";
...
while ($result = mysqli_fetch_assoc($result_set)) {
    ...
    <tr>
        ...
        <form method='post'>
        <td><input type='text' name='price_input' id='price_input' value='{$result['Price']}'></td>
        
                        <td>
                          
                              
                              <input type='hidden' name='Order_id' value='{$result['Order_id']}'>
                              <input type='submit' name='Confirm' class='buttons_style' value='Confirm' ><br>
                          </form>
                          
                          <form  method='post'>
                              <input type='hidden' name='Order_id' value='{$result['Order_id']}'>
                              <input type='submit' name='Delete' class='buttons_style' value='Delete' >
                          </form>
                      </td>
                      </tr>";
                    ...
                    if ($page_number >= $lastpage_no) {
                      ...
                      $next = "<a id='next' href=\"sellerIntaface.php?page={$next_page_no}\">NEXT</a>";
                  }
                  ...
                  if ($page_number <= 1) {
                      ...
                      $previs = "<a id='previous' href=\"sellerIntaface.php?page={$prev_page_no}\">PREVIOUS</a>";
                  }
              ...
              <div id="upbuttons">
                ...
                <a href="sellerIntaface.php"  class="upbutton" id="up1">To_Review</a>
                ...
                <a href="deleteorder.php" class="upbutton" >Removed</a>
