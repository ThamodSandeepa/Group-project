...
if(isset($_POST["Unlist"])){
  $id=$_POST['Product_id'];
  $query = "UPDATE product SET Unlisted_or_Deleted ='2' WHERE Product_id = '$id'"; 
  $query_run = mysqli_query($connection, $query);
}
?>
          ...
          <style>
            #midlebar{
                ...
                margin-right: 0;
                  ...
                  <h2  id="tablediv">Posted Products</h2>
                  <style>
                    #tablediv{
                      position: absolute;
                      margin: 20px;
                  ...
                  <div style="position: absolute; left: 50px; top: 100px; width:90%; height: 80%;">
                    ...
                    $query = "SELECT COUNT(Product_id) AS total_rows FROM product WHERE Unlisted_or_Deleted = 1";
                    ...
                    $query = "SELECT Product_id, Images, Title, Catagory FROM product WHERE Unlisted_or_Deleted = 1 ORDER BY time_date DESC LIMIT {$start}, {$rows_per_page}";
                    $result_set = mysqli_query($connection, $query);
    ...
    <tr>
        ...
        <td>
            ...
            <form action='edite.php' method='post'>
                ...
                <input type='hidden' name='Catagory' value='{$result['Catagory']}'>
                
                <input type='hidden' name='Images' value='{$result['Images']}'>
                <input type='submit' name='Edit' class='buttons_style' value='Edit' ><br>
            </form>
            <form  method='post'>
                <input type='hidden' name='Product_id' value='{$result['Product_id']}'>
                <input type='submit' name='Unlist' class='buttons_style' value='Unlist' >
            </form>
        </td>
    </tr>";
}
                    ...
                    if ($page_number >= $lastpage_no) {
                      ...
                      $next = "<a id='next' href=\"products.php?page={$next_page_no}\">NEXT</a>";
                  }
                  ...
                  if ($page_number <= 1) {
                      ...
                      $previs = "<a id='previous' href=\"products.php?page={$prev_page_no}\">PREVIOUS</a>";
                  }
              ...
              <div id="upbuttons">
                ...
                <a href="products.php" class="upbutton" id="up1">Posted</a>
                <a href="un posted.php" class="upbutton" >Unposted</a>
